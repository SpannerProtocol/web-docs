...
certainty as to their values, it is recommended you directly check the constants on the explorer.
...
BOLT have 10 decimals of precision. In other words, 10 \*\* 10 (10,000,000,000 or ten billion)
